...
def upgrade() -> None:
    ...
    sa.Column('bet_type', sa.Enum('PLAYER_PROP', 'TEAM_PROP', 'GAME_TOTAL', 'SPREAD', 'MONEYLINE', name='bettype'), nullable=False),
    ...
    sa.Column('result', sa.Enum('WIN', 'LOSS', 'PUSH', 'PENDING', 'CANCELLED', name='betresult'), nullable=False),
    ...
    sa.Column('prop_type', sa.Enum('POINTS', 'REBOUNDS', 'ASSISTS', 'THREE_POINTERS', 'STEALS', 'BLOCKS', 'TURNOVERS', 'FIELD_GOALS_MADE', 'FREE_THROWS_MADE', 'DOUBLE_DOUBLE', 'TRIPLE_DOUBLE', name='proptype'), nullable=True),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('team_bets',
    sa.Column('bet_type', postgresql.ENUM('PLAYER_PROP', 'TEAM_PROP', 'GAME_TOTAL', 'SPREAD', 'MONEYLINE', name='bettype'), autoincrement=False, nullable=False),
    ...
    sa.Column('result', postgresql.ENUM('WIN', 'LOSS', 'PUSH', 'PENDING', 'CANCELLED', name='betresult'), autoincrement=False, nullable=False),
    ...
    sa.Column('prop_type', postgresql.ENUM('POINTS', 'REBOUNDS', 'ASSISTS', 'THREE_POINTERS', 'STEALS', 'BLOCKS', 'TURNOVERS', 'FIELD_GOALS_MADE', 'FREE_THROWS_MADE', 'DOUBLE_DOUBLE', 'TRIPLE_DOUBLE', name='proptype'), autoincrement=False, nullable=False),
    sa.Column('prop_line', sa.NUMERIC(), autoincrement=False, nullable=False),
