...
async def seed_bets():
    ...
    sample_bets = [
        ...
        },
        {
            ...
            "over_under": "under",
            "prop_description": "LeBron James Assists",
        ...
        },
        {
            ...
            "over_under": "over",
            "prop_description": "Stephen Curry Three Pointers Made",
        ...
        },
        {
            ...
            "over_under": "under",
            "prop_description": "Jayson Tatum Total Rebounds",
        ...
        },
        {
            ...
            "over_under": "over",
            "prop_description": "Giannis Antetokounmpo Points",
        ...
        # Team/Game prop bets
        {
            ...
            "payout": Decimal("95.45"),
            "notes": "Celtics scored 118 points"
        },
        {
            ...
            "payout": Decimal("0.00"),
            "notes": "High-scoring game, total was 232"
        },
        {
...
async def print_summary():
    ...
    async with AsyncSessionLocal() as session:
        ...
        print(f"  Net P&L: ${net_result} ({'✅ Profit' if net_result > 0 else '❌ Loss' if net_result < 0 else '➖ Break Even'})")
        print("="*50)
