...
async def get_bet_summary(
    ...
    return {
        ...
        "player_bets": {
            ...
            "win_rate": round((player_win_count / player_total_count * 100) if player_total_count > 0 else 0, 2)
        },
        "team_bets": {
            "total": team_total_count,
            "wins": team_win_count,
            "losses": team_loss_count,
            "win_rate": round((team_win_count / team_total_count * 100) if team_total_count > 0 else 0, 2)
        }
    }